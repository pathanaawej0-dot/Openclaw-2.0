# 🦞 OpenClaw 2.0 — Personal AI Assistant
...
**OpenClaw 2.0** is a _personal AI assistant_ you run on your own devices.
Introducing the **Self-Evolving Dynamic Tools** engine — OpenClaw can now build its own tools and skills, adapting to your needs in real-time.
...
## Self-Evolving Dynamic Tools

OpenClaw 2.0 introduces the ability to **create, modify, and repair its own tools** using the new Dynamic Tools engine.

- **Autonomous Adaptation**: When the assistant encounters a task it can't solve with existing tools, it can propose and generate a new tool or skill.
- **Skill Evolution**: Existing skills can be refined and optimized by the agent itself based on usage patterns and performance feedback.
- **Integrated Development**: Leverage the power of your favorite models to write, test, and deploy code directly into your workspace.

Details: [Dynamic Tools](https://docs.openclaw.ai/tools/dynamic).

## Highlights

- **[Self-Evolving Dynamic Tools](https://docs.openclaw.ai/tools/dynamic)** — AI-driven skill creation and adaptation.
